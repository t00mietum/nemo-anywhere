...
<table style="border: none; border-collapse: collapse;">
	<tr style="border: none; border-collapse: collapse;">
		...
		<td style="border: none;">The legendary Nemo filemanager, ported to Windows, macOS, and BSD - as well Linux without the Cinnamon dependency. Also with several major new convenience features.</td>
	</tr>
</table>
