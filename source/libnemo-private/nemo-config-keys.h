...
static const NemoConfigKey nemo_config_keys[] = {
	...
	{ "compat.background", "show-desktop-icons", NEMO_CONFIG_BOOL, "false", NULL, NULL, NULL },
	{ "compat.cinnamon-interface", "clock-use-24h", NEMO_CONFIG_BOOL, "true", NULL, NULL, NULL },
	{ "compat.lockdown", "disable-command-line", NEMO_CONFIG_BOOL, "false", NULL, NULL, NULL },
	{ "compat.media-handling", "automount", NEMO_CONFIG_BOOL, "true", NULL, NULL, NULL },
	{ "compat.media-handling", "automount-open", NEMO_CONFIG_BOOL, "true", NULL, NULL, NULL },
	{ "compat.privacy", "remember-recent-files", NEMO_CONFIG_BOOL, "true", NULL, NULL, NULL },
	{ "compat.terminal", "exec", NEMO_CONFIG_STRING, "", NULL, NULL, NULL },
	{ "compat.terminal", "exec-arg", NEMO_CONFIG_STRING, "-e", NULL, NULL, NULL },
	...
	{ "list-view", "enable-folder-expansion", NEMO_CONFIG_BOOL, "false", NULL, NULL, "If true, allow folders with content to be expanded in the current view." },
	...
	{ "preferences", "inherit-show-thumbnails", NEMO_CONFIG_BOOL, "false", NULL, NULL, "Inherit thumbnail visibility from parent" },
	...
	{ "preferences", "size-prefixes", NEMO_CONFIG_ENUM, "base-10", NULL, enum_SizePrefixes, "Prefixes used for file sizes" },
