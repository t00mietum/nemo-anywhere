...
#define NEMO_WINDOW_STATE_LINK_FILE_KIND			"link-file-kind"
#define NEMO_WINDOW_STATE_LINK_FOLDER_KIND			"link-folder-kind"
#define NEMO_WINDOW_STATE_LINK_RELATIVE				"link-relative"
