...
reload_actions_layout (NemoActionManager *action_manager)
{
    ...
    path = g_build_filename (nemo_get_user_config_root (), NEMO_APP_SLUG, LAYOUT_FILENAME, NULL);
...
monitor_nemo_config_dir (NemoActionManager *action_manager)
{
    ...
    g_autofree gchar *path = g_build_filename (nemo_get_user_config_root (), NEMO_APP_SLUG, NULL);
