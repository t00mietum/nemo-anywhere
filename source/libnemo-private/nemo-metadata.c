...
static char *used_metadata_names[] = {
  ...
  (char *)NEMO_METADATA_KEY_ICON_VIEW_IMAGE_ZOOM_LEVEL,
  ...
  (char *)NEMO_METADATA_KEY_COMPACT_VIEW_ALL_COLUMNS_SAME_WIDTH,
  (char *)NEMO_METADATA_KEY_ICON_VIEW_LABELS_BESIDE_ICONS,
  (char *)NEMO_METADATA_KEY_LIST_VIEW_ENABLE_EXPANSION,
  (char *)NEMO_METADATA_KEY_SORT_DIRECTORIES_FIRST,
  (char *)NEMO_METADATA_KEY_SORT_FAVORITES_FIRST,
  ...
  (char *)NEMO_METADATA_KEY_DESKTOP_GRID_ADJUST,
  (char *)NEMO_METADATA_KEY_PINNED,
  (char *)NEMO_METADATA_KEY_FAVORITE,
  (char *)NEMO_METADATA_KEY_FAVORITE_AVAILABLE,
  (char *)NEMO_METADATA_KEY_FOLDER_SETTINGS_SAVED,
  (char *)NEMO_METADATA_KEY_LIST_VIEW_COLUMN_WIDTHS,
  NULL
};
