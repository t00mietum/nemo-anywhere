		      ...
		      gpointer callback_data)
{
	...
	/* The window and the uri are only ever wanted for this line, and the uri
	   is an allocation, so neither is worth making when nothing reads it. */
	if (DEBUGGING) {
		char *uri = nemo_view_get_uri (view);
...
static const GtkActionEntry directory_view_entries[] = {
  ...
  /* tooltip */                  N_("Show the Windows properties of each selected item"),
#else
  ...
  /* label, accelerator */       "PropertiesAccel", "<Primary>I",
  /* tooltip */                  NULL,
				 G_CALLBACK (action_properties_callback) },
  /* name, stock id */         { NEMO_ACTION_ADVANCED_PROPERTIES, "document-properties-symbolic",
  /* label, accelerator */       N_("_Properties"), "<Primary>Return",
  /* tooltip */                  N_("View or modify the properties of each selected item"),
  ...
  /* label, accelerator */       N_("_Open"), "<Primary>o",
  ...
  /* label, accelerator */       N_("Open in navigation window"), "<Primary><shift>o",
  ...
  /* label, accelerator */       N_("Open containing folder"), "<Primary><alt>O",
  ...
  /* label, accelerator */       N_("Cu_t"), "<Primary>X",
  ...
  /* label, accelerator */       N_("_Copy"), "<Primary>C",
  ...
  /* label, accelerator */       N_("Copy _path"), "<Primary><shift>C",
  ...
  /* label, accelerator */       N_("_Paste"), "<Primary>V",
  ...
  /* label, accelerator */       N_("Select i_tems matching..."), "<Primary>S",
  ...
  /* label, accelerator */       N_("_Invert selection"), "<Primary><shift>I",
...
#ifdef G_OS_WIN32
  /* label, accelerator */       N_("_Windows properties"), NULL,
  /* tooltip */                  N_("Show the Windows properties of this folder"),
#else
...
#ifdef G_OS_WIN32
		gtk_action_set_tooltip (action, _("Show the Windows properties of the open folder"));
#else
		gtk_action_set_tooltip (action, _("View or modify the properties of the open folder"));
#endif
	} else {
#ifdef G_OS_WIN32
		gtk_action_set_tooltip (action, _("Show the Windows properties of each selected item"));
#else
				   ...
				   GdkEventScroll *event)
{
	...
	if (event->state & eel_gtk_primary_mask (event->window)) {
