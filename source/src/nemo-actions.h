...
#define NEMO_ACTION_LOCATION_OPEN "LocationOpen"
...
#define NEMO_ACTION_LOCATION_OPEN_IN_TERMINAL "LocationOpenInTerminal"
#define NEMO_ACTION_LOCATION_OPEN_AS_ROOT "LocationOpenAsRoot"
#define NEMO_ACTION_LOCATION_NEW_FOLDER "LocationNewFolder"
...
#define NEMO_ACTION_MOUNT_ARCHIVE "MountArchive"
...
#define NEMO_ACTION_EDIT_LINK "Edit Link"
...
static const ConfigurableMenuItemInfo CONFIGURABLE_MENU_ITEM_INFO [] = {
    ...
    { NEMO_ACTION_EDIT_LINK, NULL,
     "/selection/File Actions/Edit Link", "selection-menu-make-link" },
    ...
    { NEMO_ACTION_BACKGROUND_COMPRESS, "background_menu__compress_check",
     "/background/Before Zoom Items/File Actions/BackgroundCompress", "background-menu-compress" },
